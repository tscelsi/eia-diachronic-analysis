...
Running spider: scrapy crawl --set=ROBOTSTXT_OBEY='False' irena_remap
"""
...
class IRENARemap(scrapy.Spider):
    name="irena_remap"
    ...
    def __init__(self, save_path):
        self.irena_remap_save_path = save_path
    ...
    def get_pdf(self, response):
        ...
        with open(os.path.join(self.irena_remap_save_path, file_name), "wb") as fp:
